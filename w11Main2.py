def GeorgeBushSpeech():
    GeorgeBush=list()
    GeorgeBush=["vice President Cheney Mr Chief Justice President Carter President Bush President Clinton reverend clergy distinguished guests fellow citizens",
"on this day prescribed by law and marked by ceremony we celebrate the durable wisdom of our constitution and recall the deep commitments that unite our countr" ,"I am grateful for the honor of this hour mindful of the consequential times in which we live and determined to fulfill the oath that I have sworn and you have witnessed ",
...
"in America's ideal of freedom citizens find the dignity and security of economic independence instead of laboring on the edge of subsistence","this is the broader definition of liberty that motivated the homestead acta the social security act and the G.I. bill of rights","and now we will extend this vision by reforming great institutions to serve the needs of our time","to give every American a stake in the promise and future of our country we will bring the highest standards to our schools and build an ownership society","we will widen the ownership of homes and businesses retirement savings and health insurance preparing our people for the challenges of life in a free society","by making every citizen an agent of his or her own destiny we will give our fellow Americans greater freedom from want and fear and make our society more prosperous and just and equal",
...
"when the declaration of independence was first read in public and the liberty Bell was sounded in celebration a witness said It rang as if it mean",
"may god bless you and may he watch over the United States of America"]
    ...
    for i in range(len(a)): 
        if a[i]>=24: 
            c.append(b[i])
    print "GeorgeBush was likely to say words "+str(c)+" in his speech"



def RooseveltSpeech():
    Roosevelt=list()
    Roosevelt=["Mr. Chief Justice Mr. Vice President my friends you will understand and I believe agree with my wish that the form of this inauguration be simple and its words brief",
...
"so we pray to him now for the vision to see our way clearly to see the way that leads to a better life for ourselves and for all our fellow men to the achievement of his will to peace on earth"]
    ...
    for i in range(len(a)): 
        if a[i]>=5: 
            c.append(b[i])
    print "Roosevelt was likely to say words "+str(c)+" in his speech"
